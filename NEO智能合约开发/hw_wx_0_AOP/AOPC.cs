...
namespace NEP5
{
    public class NEP5 : SmartContract
    {
        ...
        private static readonly BigInteger TotalSupplyValue = 10000;
        ...
        [DisplayName("name")]
        public static string Name() => "A.O.P. Coin"; //name of the token

        [DisplayName("symbol")]
        public static string Symbol() => "AOPC"; //symbol of the token
