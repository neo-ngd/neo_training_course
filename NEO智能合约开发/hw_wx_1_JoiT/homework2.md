...
请自己定义一个新的NEP-5合约,并且在GUI中能够看到这笔资产

### 执行结果

[result](https://assets.myjoit.com/images/neo/neo_homework/neo_homework_2.png)
...
namespace NeoContract1
{
    ...
    {
        //Token Settings
        public static string Name() => "YouLoveApple";
        public static string Symbol() => "YLA";
        public static readonly byte[] Owner = "AbG2ky7Zb7YGdMMSVRg5aLYfSZeB5juyqk".ToScriptHash();
        ...
        private const int ico_start_time = 1560441600;
        private const int ico_end_time = 1592064000;
